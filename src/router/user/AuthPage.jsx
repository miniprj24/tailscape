...
const AuthPage = () => {
    ...
    return (
        <div
            className={`min-h-screen bg-blue-100 flex items-center justify-center p-4 overflow-hidden transition-colors duration-500 ${
                mode === 'admin' ? 'bg-red-100' : 'bg-blue-100'
            }`}
        >
            <div className="relative w-full max-w-4xl">
                <div
                    className={`absolute -top-9 -left-9 w-24 h-24 z-0 rounded-full flex items-center justify-center overflow-hidden transition-all duration-500 ease-in-out transform hover:scale-110 ${
                        mode === 'admin' ? 'bg-red-200' : 'bg-blue-200'
                    }`}
                >
                    <FaDog
                ...
                <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
                    <div className="md:flex">
                        <div
                            className={`md:w-1/2 p-8 z-10 relative ${getSlideClass(
                                slideLeftDirection
                            )}`}
                        >
                            <h2
                        ...
                        >
                            ...
                            <ul className="space-y-2">
                                {mode === 'admin' ? (
                                    ...
                                    <>
                                        <li className="flex items-center transition-transform duration-300 hover:translate-x-2">
                                            <FaDog className="mr-2" /> Track
                                            your pet’s progress
                                        </li>
                                        <li className="flex items-center transition-transform duration-300 hover:translate-x-2">
                                            <FaDog className="mr-2" /> Access
                                            resources
                                        </li>
                                        <li className="flex items-center transition-transform duration-300 hover:translate-x-2">
                                            <FaDog className="mr-2" /> Connect
                                            with experts
                                        </li>
                                    </>
                                )}
